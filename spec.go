	...
	return sdk.Specification{
		...
		SourceParams: map[string]sdk.Parameter{
			ConfigServiceAccount: {
				Default:     "",
				Required:    true,
				Description: "Path to service account key with data pulling access. ref: https://cloud.google.com/docs/authentication/getting-started", // We can also take it as value if required
			},
			ConfigProjectID: {
				Default:     "",
				Required:    true,
